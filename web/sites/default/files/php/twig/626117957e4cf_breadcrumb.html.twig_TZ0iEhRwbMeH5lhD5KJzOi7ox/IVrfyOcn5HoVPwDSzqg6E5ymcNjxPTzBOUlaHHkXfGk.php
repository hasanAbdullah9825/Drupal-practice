...
/* themes/custom/mytheme/templates/navigation/breadcrumb.html.twig */
class __TwigTemplate_2cc03eb59c7a05d68f42dad89464b915bf6227624d0f846ed083ace91e35cd76 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "themes/custom/mytheme/templates/navigation/breadcrumb.html.twig";
    }
  ...
  <nav class=\"breadcrumb\" role=\"navigation\" aria-labelledby=\"system-breadcrumb\">
    ...
    {% for item in breadcrumb %}
      <li class=\"breadcrumb-item\">
        {% if item.url %}
          <a href=\"{{ item.url }}\">{{ item.text }}</a><i class=\"fa fa-angle-right breadcrumb-item-seperator\" aria-hidden=\"true\"></i>
        {% else %}
          {{ item.text }}
        {% endif %}
      </li>
...
{% endif %}
", "themes/custom/mytheme/templates/navigation/breadcrumb.html.twig", "C:\\wamp64\\www\\demo_project_drupal\\web\\themes\\custom\\mytheme\\templates\\navigation\\breadcrumb.html.twig");
    }
